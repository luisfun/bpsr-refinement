...
export const gearRefinementTable = [
  ...
  { level: 16, star: 4, craft: 40, success: 0.55 },
  { level: 17, star: 4, craft: 40, success: 0.5 },
  { level: 18, star: 5, craft: 50, success: 0.5 },
  { level: 19, star: 6, craft: 50, success: 0.45 },
  { level: 20, star: 8, craft: 60, success: 0.45 },
] as const satisfies readonly RefinementData[]
